    ...
    <div class="card m-2 p-4">
        ...
        <div>
            <p
                class:middle-stroke={IsComplete}
                class:disabled={IsComplete}
                class="text-dark fs-16 " style="text-overflow: ellipsis; -webkit-line-clamp: 2;  width: 100%; /* Adjust the width to your needs */
                white-space: nowrap;
                overflow: hidden;"
            >
                {note}
